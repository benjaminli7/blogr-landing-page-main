...
items.forEach(function(item) {
    ...
    //     item.getElementsByClassName('dropdown-content')[0].classList.toggle('span-block');
    //     item.getElementsByClassName('icon-arrow-dark')[0].classList.toggle('translate')
    // })
    ...
    span.addEventListener('click', () => {
        items.forEach(function(r) {
            if(r !== item) {
                r.getElementsByClassName('dropdown-content')[0].classList.remove('span-block')
                r.getElementsByClassName('icon-arrow-dark')[0].classList.remove('translate')
